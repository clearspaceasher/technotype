      ...
      return (
        <div className="min-h-screen bg-black text-terminal-light p-8 font-mono flex items-center justify-center">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-8 text-terminal-accent">Learn More</h2>
            <div className="text-lg text-terminal-light/80 whitespace-pre-line mb-8">
              <AnimatedText text={technotypeDescription} speed={18} className="text-terminal-light/80 text-lg whitespace-pre-line" />
            </div>
          </div>
        </div>
      );
          ...
          >
            ...
            {showReveal && (
              <div className="bg-black/80 border border-terminal-accent/50 rounded-lg p-8 mb-8 flex flex-col items-center justify-center">
                <h2 className="text-5xl md:text-6xl font-extrabold mb-8 text-terminal-accent drop-shadow-lg animate-glow">
                ...
                <motion.div
                  ...
                  className="mt-16 mb-8 flex items-center justify-center gap-3 text-2xl md:text-4xl text-terminal-accent font-mono hover:text-glow transition-all duration-300 transform hover:scale-105 cursor-pointer select-none"
                  animate={{
                    x: [0, 20, 0, -20, 0],
                    y: [0, -10, 0, -10, 0]
                  }}
